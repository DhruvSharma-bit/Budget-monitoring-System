...
function EventsPage() {
  ...
  const { events, addEvent, updateEvent, canEdit } = useBudget()
  ...
  const handleEditSubmit = (event) => {
    event.preventDefault()
    updateEvent(editForm.id, { name: editForm.name, date: editForm.date })
  ...
  return (
    <div>
      ...
      <Modal title="Add New Event" isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
      ...
      <Modal title="Edit Event" isOpen={isEditModalOpen} onClose={() => setEditModalOpen(false)}>
